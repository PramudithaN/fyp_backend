...
PREDICTION_LOCK_SCHEDULE_HOUR = int(os.getenv("PREDICTION_LOCK_SCHEDULE_HOUR", "7"))
...
EXPLAINABILITY_SCHEDULE_TIMEZONE = os.getenv(
    "EXPLAINABILITY_SCHEDULE_TIMEZONE", "Asia/Colombo"
)
EXPLAINABILITY_SCHEDULE_HOUR = int(os.getenv("EXPLAINABILITY_SCHEDULE_HOUR", "7"))
